...
deps: ## Install development dependencies
	opam install -y dune-release ocamlformat=0.20.1 utop ocaml-lsp-server
...
.PHONY: build
build: fmt ## Build the project, including non installable libraries and executables
...
fmt: ## Format the codebase with ocamlformat
	opam exec -- dune build --root . --auto-promote @fmt || return 0
